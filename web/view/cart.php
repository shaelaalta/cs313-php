        ...
        <main id="cart">
            ...
            $pd = '<div id="cart">';
                foreach($list as $lists){
                    ...
                    $pd .= "<form id='remCart' action='/shop/shopIndex.php' method='post'><button type='submit' name='action' value='remove'>Remove From Cart</button><input type='hidden' name='invName' value='" .$lists[1] ."'></form>";
                    $pd .= "<hr></div>";
                }
            $pd .="</div>";
            echo $pd;
